...
export default function GalleryItem(image: Readonly<TImage>) {
  ...
  return (
    ...
    >
      <Image
        alt={title}
        src={imageSrc}
        className='w-full aspect-video object-cover object-center hover:scale-105 duration-500 ease-in-out'
        width={500}
        height={500}
        priority={false}
        loading='eager'
